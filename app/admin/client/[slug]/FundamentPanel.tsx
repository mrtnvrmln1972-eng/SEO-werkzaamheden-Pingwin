...
export default function FundamentPanel({ slug, positioneringUrl, huisstijlUrl, adsAccountUrl, onGaNaar }: {
  ...
  // Vier kaarten onder elkaar, altijd open: stond even achter een hover-
  // uitklapper (25-08-2026), maar dat hoveren was niet handig, zeker niet
  // op een touchpad of telefoon. Nu staan ze gewoon uitgeschreven, als eigen
  // kolom naast Onboarding in plaats van eronder (zie ClientCockpit.tsx).
  return (
    <>
      {BLOKKEN.map((blok, i) => {
