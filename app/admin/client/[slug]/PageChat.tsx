    ...
    <div className="page-chat-wrap">
      ...
      <div className={"page-chat-docs step-card step-card-4" + (allStepsDone ? " done" : "")}>
          <div className="step-head" onClick={() => setVervolgOpen((o) => !o)}>
            ...
            <span onClick={(e) => e.stopPropagation()}><HelpHint xl title="Stap 3 — Documenten (analyse, blauwdruk, copy)" text={"In deze stap wordt de vastgelegde strategie uitgewerkt tot drie documenten die bewust op elkaar voortbouwen: eerst wordt vastgesteld waar de pagina staat (analyse), dan hoe hij eruit moet komen te zien (blauwdruk), en pas daarna wordt de tekst geschreven (copy). Elke stap leest het resultaat van de vorige, zodat de copy nooit losstaat van de analyse die eraan voorafging. Alles draait op de achtergrond, landt als net Pingwin-document in de Drive-klantmap (of als download) en wordt automatisch een afgeronde werkzaamheid in de takenlijst.\n## De SEO-analyse: eerst eerlijk meten waar de pagina staat\nDe analyse begint met het verzamelen van alle feiten over de pagina. De pagina zelf wordt echt uitgelezen en doorgemeten: de bestaande koppen, de meta-title en -description, het woordenaantal, de zoekwoorddichtheid, de FAQ en de aanwezige structured data. Daarnaast worden de Search Console-rankings van de afgelopen negentig dagen opgehaald (op welke zoekwoorden rankt hij, met hoeveel klikken en vertoningen), de laadsnelheid uit PageSpeed, en via Ahrefs de top-10 van het primaire zoekwoord inclusief de autoriteit van elke concurrent. De drie best scorende concurrenten worden zelfs individueel uitgemeten, zodat de vergelijking niet op indrukken maar op cijfers rust.\nMet al die data wordt de pagina beoordeeld tegen een vaste set meetbare criteria, van zoekintentie tot koppenstructuur en van meta-lengtes tot E-E-A-T-signalen. De pagina krijgt een hard eindoordeel: hij slaagt pas bij nul kritieke gebreken, hooguit twee grote, en een totaalscore van minimaal 85. Belangrijk daarbij is dat de analyse óók expliciet benoemt wat er goed is en dus moet blijven staan. Dat is geen beleefdheid maar strategie: bestaande rankings zijn opgebouwde waarde, en die bescherm je door alleen te veranderen wat aantoonbaar tekortschiet.\n## De blauwdruk: de bouwtekening, gebaseerd op wie er nu wint\nDe blauwdruk vertaalt de analyse naar een concrete paginastructuur, en baseert die op de top-10 van het gekozen zoekwoord. Omdat de winnende concurrenten echt zijn uitgemeten, is precies bekend welke onderwerpen en invalshoeken zij behandelen, hoe lang hun pagina's zijn en welke vragen zij beantwoorden. De blauwdruk schrijft vervolgens voor welke koppen en secties de pagina nodig heeft om die dekking te evenaren, plus, en dat is de kern, wat de pagina uniek maakt: de invalshoek of het onderwerp dat de concurrenten laten liggen en dat Google een reden geeft om jóu in die top-10 te zetten in plaats van een kopie van nummer drie.\nAlles daarin is meetbaar gemaakt. Het primaire zoekwoord hoort in 60 tot 80 procent van de koppen terug te komen (met 70 procent als doel; daarboven oogt het onnatuurlijk en telt het als stuffing), een plaatsnaam in hooguit twee à drie koppen, de meta-title is 50 tot 60 tekens met het zoekwoord vooraan, en de FAQ dekt in vier tot zes vragen de echte zoekintentie. Ook levert de blauwdruk een lijst van tien tot vijftien semantische varianten die verderop in de copy verwerkt moeten worden.\n## De copy: de volledige tekst, met behoud van wat al goed is\nDe copy-stap schrijft de daadwerkelijke, complete paginatekst uit; geen samenvatting of advies, maar tekst die zo de site op kan. En hier geldt een principe dat het verschil maakt met een tekstrobot: de bestaande tekst van de pagina is als bron meegegeven, en alles wat daarvan voldoet aan de criteria wordt zoveel mogelijk behouden of hergebruikt. Goede bestaande zinnen, kloppende alinea's en werkende koppen blijven dus staan; er wordt alleen geschreven wat ontbreekt of aantoonbaar beter moet. Zo voorkom je dat een pagina die al deels rankt, wordt platgewalst door een volledig nieuwe tekst; dat zou bestaande posities onnodig op het spel zetten.\nDe nieuwe tekst volgt de blauwdruk sectie voor sectie: reken op zes tot negen inhoudelijke secties met volle alinea's van 80 tot 150 woorden, het primaire zoekwoord in de eerste honderd woorden, een natuurlijke dichtheid van een half tot twee procent, minstens 60 procent van de varianten verwerkt, en een uitgebreide FAQ van zes tot acht vragen met echte antwoorden van 40 tot 80 woorden, gericht op long-tail-zoekers. De toon komt uit de tone-of-voice-analyse in het klantprofiel, zodat de tekst klinkt als dit bedrijf. Als sluitstuk draait er een automatische nacontrole over de koppen die te veel herhaling van een naam of plaatsnaam detecteert en herschrijft.\n## Waarom deze volgorde werkt\nElke stap dwingt de kwaliteit van de volgende af. Zonder analyse zou de blauwdruk gokken wat er mis is; zonder blauwdruk zou de copy structuurloos worden geschreven; en doordat alles teruggrijpt op de vastgelegde strategie uit stap 1, bewaakt de keten dat de pagina precies de rol vervult die in het plan is afgesproken. Standaard krijg je van elk document de korte klantversie; onder elke stap kun je ook de uitgebreide interne versie laten maken, met de volledige scorecard en onderbouwing voor eigen gebruik of overdracht."} /></span>
          </div>
          {vervolgOpen && (
