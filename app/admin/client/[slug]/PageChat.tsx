    ...
    <div className="page-chat-wrap">
      ...
      <div className={"page-chat step-card step-card-2" + (taskDone ? " done" : "")}>
        <div className="step-head" onClick={() => setChatOpen((o) => !o)} title={chatOpen ? "Chat inklappen" : "Chat uitklappen"}>
          ...
          <span onClick={(e) => e.stopPropagation()}><HelpHint xl title="Stap 2 — Chat over deze pagina" text={"Hier werk je samen met de AI de strategie voor deze pagina uit, als een sparringsessie met een SEO-strateeg die alle data al voor zich heeft liggen.\nWat de chat automatisch weet (zonder dat je iets hoeft te plakken):\n- De live status en titel van de pagina, en de Search Console-rankings (op welke zoekwoorden, welke positie, hoeveel klikken).\n- De volledige paginalijst van de site en welke andere pagina's op dezelfde zoekwoorden ranken (kannibalisatie).\n- Het klantprofiel (positionering, werkgebied, tone of voice) en de bestaande taken en plannen.\nWat de chat zelf kan opzoeken tijdens het gesprek: echte zoekvolumes en zoekintenties, de top-10 van een zoekwoord met de autoriteit van concurrenten, waar een concurrent-URL op rankt, de backlinks en Domain Rating van jullie site of een concurrent, en de echte inhoud van elke pagina.\nHoe je hem gebruikt: stel je vraag ('Hoe staat deze pagina ervoor?', 'Wat is de beste strategie?'), praat door tot je het eens bent, en sluit af met 'Vat samen tot conclusie & strategie'. Die conclusie neem je met één klik over als het plan van stap 1, geef je door aan betrokken pagina's (stap 3) en leg je vast als document."} /></span>
