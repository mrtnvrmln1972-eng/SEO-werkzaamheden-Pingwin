  ...
  return (
    <div className="cockpit-card strategy-card">
      <button type="button" className="strategy-head" onClick={() => setOpen((v) => !v)}>
        ...
        <span className="strategy-title">Bedrijfsgegevens (voor structured data) <HelpHint wide title="Bedrijfsgegevens" text={"De vaste bedrijfsinformatie (adres, telefoon, openingstijden, logo, profielen) die de basis vormt voor de structured data van de hele site.\n- Vul automatisch vanaf de website en loop de velden na.\n- Deel de link met de klant zodat die kan corrigeren en aanvullen.\n- Vergrendel daarna: vanaf dan is dit de vaste bron voor stap 7 (structured data) op alle pagina's."} /></span>
