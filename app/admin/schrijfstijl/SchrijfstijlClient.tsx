  ...
  return (
    <>
      ...
      <div className="pg-container">
        <div className="card pg-kop">
          <h1 className="pg-h1">Hoe jij schrijft</h1>
          <p className="pg-uitleg">
        ...
        <div className="card pg-blok">
          <div className="pg-balk">
          ...
          {fout && <div className="pg-fout">{fout}</div>}
          {msg && <div className="pg-ok">{msg}</div>}

          <div className="pg-veld-kop">
            <h2 className="pg-h2">Het profiel</h2>
            <button type="button" className="pg-schakel" onClick={() => setBewerkt((v) => !v)}>
          ...
          */}
          {bewerkt ? (
            ...
            <div className="pg-lees md" dangerouslySetInnerHTML={{ __html: mdToHtml(profiel) }} />
          ) : (
          ...
          {!!stijl?.voorbeelden?.length && (
            <>
              <h2 className="pg-h2">Zinnen van jou, als ijkpunt voor de toon</h2>
              <ul className="pg-citaten">{stijl.voorbeelden.map((v, i) => <li key={i}>{v}</li>)}</ul>
              <p className="muted pg-klein">
