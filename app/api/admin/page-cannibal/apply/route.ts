...
import { applyPageCannibal } from "../../../../../lib/page-cannibal";
...
// Zet de cannibalisatie-uitkomst door: redirects + interne links als Dev-taak (met
// document), en de de-optimalisatie-/behoud-aanwijzingen als basisinfo naar de
// blijvende pagina's.
export async function POST(req: NextRequest) {
  ...
  try {
    const r = await applyPageCannibal(slug, url);
