...
/* =========================================================
 * 3c. COMPONENT: createSubSubHeading (H3, één niveau onder subheading)
 *
 * Voor koppen die logisch onder een H2 vallen, zoals de titels van
 * FAQ-/veelgestelde-vragen. Echte Heading 3 (voor structuur/navigatie),
 * ingesprongen en iets kleiner dan de subheading zodat de hiërarchie klopt.
 * ======================================================= */
function createSubSubHeading(text) {
  return new Paragraph({
    heading: HeadingLevel.HEADING_3,
    spacing: { before: 180, after: 70, line: 300 },
    indent: { left: 360 },
    keepNext: true,
    keepLines: true,
    children: [
