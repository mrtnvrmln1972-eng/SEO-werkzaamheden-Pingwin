 ...
 * 1. DESIGN TOKENS
 * ======================================================= */
// Waarden gemeten op pingwin.nl (huisstijl-skill, pingwin-design-tokens.md).
// Het dashboard zelf gebruikte deze al; alleen de documentgenerator stond nog op de
// oude Word-variant (Noto Sans, #F6712C), waardoor een gegenereerd document er
// anders uitzag dan het dashboard eromheen. De site is leidend.
const T = {
  font: "Montserrat",
  color: {
    ...
    accentHover: "C95E28",
    accentSoft:  "FFF4EE",   // lichte oranje vlakken in het dashboard
    red:         "A22F3B",
    blue:        "0E7E9A",
    brown:       "84796B",
    headingDark: "2F2A2A",
...
/* =======================================================
 * VANGNET: flat(children)
 * createCoverPage / createSectionDivider / createHighlightBox /
 * createBulletList geven een ARRAY terug. Wikkel je children-lijst
 * ALTIJD in flat(): het slaat geneste arrays plat en verwijdert losse
 * primitieven (getallen/null), zodat er nooit een ongeldig <0/>-element
 * in de XML lekt (dat maakt het .docx corrupt en onopenbaar).
 *   children: flat([ ...createCoverPage(), createSectionDivider(x), ... ])
 * ======================================================= */
function flat(children) {
  return (Array.isArray(children) ? children : [children]).flat(Infinity).filter((c) => c && typeof c === "object");
}
